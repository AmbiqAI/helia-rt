...
<canvas id="bench-speedup-chart" data-chart-config='{
  ...
  "data": {
    ...
    "datasets": [
      {
        "label": "Speedup (×)",
        "data": [706, 99.6, 96.5, 52.4, 23.1, 13.7, 13.2, 10.0, 9.2, 8.8, 6.7, 6.2, 3.7, 3.3, 3.2, 2.9, 2.9, 2.4, 1.96, 1.77, 1.39, 1.35, 1.34, 1.26, 1.26, 1.04, 1.01, 1.01, 1.00, 1.00, 1.00, 1.00, 1.00, 1.00, 1.00, 0.99],
        "backgroundColor": [
