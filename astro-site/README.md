...
The trial writes Doxygen XML, the extracted model and warnings under `.cache/reference-trial/`. It uses the pinned helia-ui package and selected RT headers without modifying the headers. These artifacts are diagnostic and are not published.
