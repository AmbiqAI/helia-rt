...
void leaky_relu_s8(
  ...
  const in32_t input_offset = data.input_zero_point;
  const in32_t output_offset = data.output_zero_point;
  const in32_t output_multiplier_alpha = data.output_multiplier_alpha;
  const in32_t output_shift_alpha = data.output_shift_alpha;
  const in32_t output_multiplier_identity = data.output_multiplier_identity;
  const in32_t output_shift_identity = data.output_shift_identity;
  ...
  while (blkCnt > 0U) {
    ...
    res = arm_requantize_mve(res, output_multiplier_alpha, output_shift_alpha);
