...
void TestUnpackThreeOutputsQuantizedInt8(
    int* input_dims_data, const int8_t* input_data, int axis,
    int* output1_dims_data, const int8_t* expected_output1_data,
    int* output2_dims_data, const int8_t* expected_output2_data,
    int* output3_dims_data, const int8_t* expected_output3_data,
    int8_t* output1_data, int8_t* output2_data, int8_t* output3_data) {
  TfLiteIntArray* input_dims = IntArrayFromInts(input_dims_data);
  TfLiteIntArray* output1_dims = IntArrayFromInts(output1_dims_data);
  TfLiteIntArray* output2_dims = IntArrayFromInts(output2_dims_data);
  TfLiteIntArray* output3_dims = IntArrayFromInts(output3_dims_data);
...
void TestUnpackThreeOutputsQuantizedInt16(
    int* input_dims_data, const int16_t* input_data, int axis,
    int* output1_dims_data, const int16_t* expected_output1_data,
    int* output2_dims_data, const int16_t* expected_output2_data,
    int* output3_dims_data, const int16_t* expected_output3_data,
    int16_t* output1_data, int16_t* output2_data, int16_t* output3_data) {
  TfLiteIntArray* input_dims = IntArrayFromInts(input_dims_data);
  TfLiteIntArray* output1_dims = IntArrayFromInts(output1_dims_data);
  TfLiteIntArray* output2_dims = IntArrayFromInts(output2_dims_data);
  TfLiteIntArray* output3_dims = IntArrayFromInts(output3_dims_data);
  ...
  for (int i = 0; i < output1_dims_count; i++) {
    output1_data[i] = 12345;
  }
  for (int i = 0; i < output2_dims_count; i++) {
    output2_data[i] = 12345;
  }
  for (int i = 0; i < output3_dims_count; i++) {
    output3_data[i] = 12345;
  }
...
TF_LITE_MICRO_TEST(UnpackQuantizedInt8ThreeOutputs) {
  int input_shape[] = {2, 3, 2};
  const int8_t input_values[] = {
      10, 20, 
      30, 40,
      50, 60,
  };
  ...
  int output1_shape[] = {1, 2};
  const int8_t output1_golden[] = {10, 20};

  int output2_shape[] = {1, 2};
  const int8_t output2_golden[] = {30, 40};

  int output3_shape[] = {1, 2};
  const int8_t output3_golden[] = {50, 60};

  int8_t output1_data[2];
  int8_t output2_data[2];
  int8_t output3_data[2];

  tflite::testing::TestUnpackThreeOutputsQuantizedInt8(
      input_shape, input_values,0,
      output1_shape, output1_golden,
      output2_shape, output2_golden,
      output3_shape, output3_golden,
      output1_data, output2_data, output3_data);
}

TF_LITE_MICRO_TEST(UnpackQuantizedInt16ThreeOutputs) {
  int input_shape[] = {2, 3, 2};
  const int16_t input_values[] = {
      100, 200,
      300, 400,
      500, 600,
  };
  ...
  int output1_shape[] = {1, 2};
  const int16_t output1_golden[] = {100, 200};

  int output2_shape[] = {1, 2};
  const int16_t output2_golden[] = {300, 400};

  int output3_shape[] = {1, 2};
  const int16_t output3_golden[] = {500, 600};

  int16_t output1_data[2];
  int16_t output2_data[2];
  int16_t output3_data[2];

  tflite::testing::TestUnpackThreeOutputsQuantizedInt16(
      input_shape, input_values, 0,
      output1_shape, output1_golden,
      output2_shape, output2_golden,
      output3_shape, output3_golden,
